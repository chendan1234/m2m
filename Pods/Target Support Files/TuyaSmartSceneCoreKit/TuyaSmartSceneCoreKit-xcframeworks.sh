...
install_xcframework "${PODS_ROOT}/TuyaSmartSceneCoreKit/Build/TuyaSmartSceneCoreKit.xcframework" "TuyaSmartSceneCoreKit" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
